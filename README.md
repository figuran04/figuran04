...
<table style="width: 100%; border-collapse: collapse; color: white;">
  ...
  <tr>
    ...
    <td style="border: 1px solid white; padding: 10px; width: 300px;" width="300px">Tutorial Github— Pemrograman Berorientasi Objek (OOP)Photo by Roman Synkevych on UnsplashGitHub adalah layanan hos web bersama untuk proyek pengembang...</td>
    <td style="border: 1px solid white; padding: 10px;"><a href="https://medium.com/@dikaelsaputra/tutorial-github-29057912a19c?source=rss-272e0aace4a6------2" style="color: white; text-decoration: none;">Read More</a></td>
  </tr>
  <tr>
    ...
    <td style="border: 1px solid white; padding: 10px; width: 300px;" width="300px">Perangkat Jaringan Komputer — Jaringan KomputerJaringan komputer modern bergantung pada berbagai perangkat keras untuk menjaga koneksi yang stabil, am...</td>
